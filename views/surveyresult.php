				...
				<li>
					<ol>
						...
						<li>
							...
							<p>None: <?php echo $q1_0; ?></p>
							<div class="progress">
								<div class="bar" style="width:<?php echo $q1_0 / count($surveyResult) * 100.0; ?>%"></div>
							</div>
							<p>Low (once a week): <?php echo $q1_1; ?></p>
							<div class="progress">
								<div class="bar" style="width:<?php echo $q1_1 / count($surveyResult) * 100.0; ?>%"></div>
							</div>
							<p>Moderate (3 times a week): <?php echo $q1_2; ?></p>
							<div class="progress">
								<div class="bar" style="width:<?php echo $q1_2 / count($surveyResult) * 100.0; ?>%"></div>
							</div>
							<p>Very high (athletes and intensive sports training for competition, i.e. high intensity-high frequency): <?php echo $q1_3; ?></p>
							<div class="progress">
								<div class="bar" style="width:<?php echo $q1_3 / count($surveyResult) * 100.0; ?>%"></div>
							</div>
						</li>
						<li>
							...
							<p>Strong disagree: <?php echo $q1_0; ?></p>
							<div class="progress">
								<div class="bar" style="width:<?php echo $q1_0 / count($surveyResult) * 100.0; ?>%"></div>
							</div>
							<p>Disagree: <?php echo $q1_1; ?></p>
							<div class="progress">
								<div class="bar" style="width:<?php echo $q1_1 / count($surveyResult) * 100.0; ?>%"></div>
							</div>
							<p>Neutral: <?php echo $q1_2; ?></p>
							<div class="progress">
								<div class="bar" style="width:<?php echo $q1_2 / count($surveyResult) * 100.0; ?>%"></div>
							</div>
							<p>Agree: <?php echo $q1_3; ?></p>
							<div class="progress">
								<div class="bar" style="width:<?php echo $q1_3 / count($surveyResult) * 100.0; ?>%"></div>
							</div>
							<p>Strongly agree: <?php echo $q1_4; ?></p>
							<div class="progress">
								<div class="bar" style="width:<?php echo $q1_4 / count($surveyResult) * 100.0; ?>%"></div>
							</div>
						</li>
						<li>
						...
						<li>
							...
							<p>Yes: <?php echo $q1_0; ?></p>
							<div class="progress">
								<div class="bar" style="width:<?php echo $q1_0 / count($surveyResult) * 100.0; ?>%"></div>
							</div>
							<p>No: <?php echo $q1_1; ?></p>
							<div class="progress">
								<div class="bar" style="width:<?php echo $q1_1 / count($surveyResult) * 100.0; ?>%"></div>
							</div>
