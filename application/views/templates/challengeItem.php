<li class="challengeItem box">
	<div class="challengeContainer">
		...
		<h5><?php echo $points ?> points &middot; Max: <?php if($quota<9999) echo $quota . " Times"; else echo "No limit" ?></h5>
		<?php if ($category!=3): ?>
			<h4><i class="icon-time icon-large"></i>&nbsp;<?php echo date('H:i',strtotime($start_time)) ?>-<?php echo date('H:i', strtotime($end_time)) ?></h4>	
		<?php endif ?>
		<p><?php echo $description ?></p>
		<small>Completed <?php echo $complete_count . ($complete_count == 1 ? " Time" : " Times"); ?></small><br>
	</div>
</li>
