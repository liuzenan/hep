						...
						<div class="row-fluid">
							<table class="table activity-stats">
								<tbody>
									...
									<td class="activity-stats"><strong><span><?php echo $me_today->sleep ?></span><br><span class="activityIcon sleep"></span>&nbsp;Sleep&nbsp;</strong><i class="<?php if($delta_sleep>0) echo "icon-arrow-up"; else if ($delta_sleep<0) echo "icon-arrow-down"; ?>"></i><?php if($delta_sleep!=0) echo abs(floor($delta_sleep*100)) . '%' ?></td>
								</tbody>
							</table>
						</div>
					</div>				
